...
- 🔄 **Device Sync**: Securely sync your entire DayBook database (birthdays, avatars, settings) directly between devices over your local network using a 6-character code via WebRTC. (Note: Connection signaling uses the free PeerJS Cloud service, and may utilize public TURN servers to traverse restrictive networks.)
