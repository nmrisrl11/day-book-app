...
- 🔔 **Push Notifications**: Receive native OS-level birthday reminders directly to your desktop or mobile device via a custom Service Worker integration (delivered while the app is running).
