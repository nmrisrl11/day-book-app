...
- 🔔 **OS Notifications**: Receive native OS-level birthday reminders and new version update alerts directly to your desktop or mobile device via a custom Service Worker integration (delivered while the app is running).
