...
4.  **Notifications**: Toggle in-app birthday reminders, customize how many days in advance to be reminded, and enable/disable native OS push notifications via Service Worker.
...
- **System Push Notifications**: Natively supported via the Workbox Service Worker (`custom-sw.js`), hooking into the Notification API to send OS-level reminders. Users can click notifications to seamlessly focus or reopen the DayBook application.
