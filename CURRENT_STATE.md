...
4.  **Notifications**: Toggle in-app birthday reminders, customize how many days in advance to be reminded, and enable/disable native OS push notifications via Service Worker (delivered only while the app is running).
