	...
	return (
		<div className="flex flex-col gap-6">
				...
				<div className="flex flex-col px-4">
					<div className="flex flex-col gap-1 py-4">
						<div className="flex items-center justify-between gap-4">
							<Label className="text-sm font-semibold" htmlFor="allow-custom-uploads">
			...
			<div className="bg-card flex flex-col rounded-xl border">
				...
				<div className="flex flex-col gap-6 p-4 md:flex-row md:gap-6">
						...
						{avatarSettings.defaultLibrary === "boring-avatars" && (
							<div className="grid gap-4 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
								...
								<div className="flex flex-col gap-3">
									...
									<div className="flex flex-wrap items-center gap-3 max-sm:justify-center sm:gap-1">
