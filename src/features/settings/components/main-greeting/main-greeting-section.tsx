				...
				<div className="flex flex-col p-4">
					<div className="grid gap-6 sm:grid-cols-2">
						<div className="flex flex-col gap-3">
							<Label className="text-sm font-semibold" htmlFor="greeting-text">
								Greeting Text
							</Label>
							<Select
						...
						<div className="flex flex-col gap-3">
							<Label className="text-sm font-semibold" htmlFor="greeting-font">
								Font Style
							</Label>
							<Select
						...
						<div className="flex flex-col gap-3 sm:col-span-2">
							<h3 className="text-sm font-semibold">Color Style</h3>
							<RadioGroup
							...
							>
								<div className="flex items-center space-x-2">
									...
									<Label htmlFor="solid" className="cursor-pointer font-normal">
										Solid Color
									</Label>
								</div>
								<div className="flex items-center space-x-2">
						...
						<div className="flex flex-col gap-4 border-t pt-6 sm:col-span-2">
